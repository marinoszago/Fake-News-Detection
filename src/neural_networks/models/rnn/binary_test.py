...
dataset = pd.read_csv('../../../../data/embeddings/binary.csv',header=None)
...
def build_ann(activation1, activation2, activation3, activation4, dropout, optimizer):
    ...
    classifier.add(Dense(units=32,  activation=activation1, input_dim=300))
    ...
    classifier.add(Dense(units=2, activation=activation4))
